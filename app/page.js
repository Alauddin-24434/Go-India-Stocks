...
import { initAOS } from '@/utils/aos-init'; // Importing AOS initialization function
import Link from "next/link"; // Importing Link from Next.js

// Functional component for the home page
export default function Home() {
  // Effect hook to initialize AOS when the component mounts
  useEffect(() => {
    initAOS();
  }, []);
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen px-8 py-12 bg-gray-100">
      ...
      <div  data-aos="zoom-in" className="max-w-6xl mx-auto text-center">
        ...
        {/* Title */}
        <h1 className="text-4xl md:text-5xl lg:text-5xl  mb-8">
          <span className="text-slate-800">GO INDIA </span>
          <span className="text-red-700">STOCKS</span>
        </h1>
